...
if (!process.env['AZURE_WEB_SEARCH_KEY']) {
  throw new Error('please set/export the following environment variable: AZURE_WEB_SEARCH_KEY');
}

let serviceKey = process.env['AZURE_WEB_SEARCH_KEY'];
